...
export class TodoList {
  ...
  deleteTodo(child,event) {
    ...
    this._container.children[2].removeChild(child);
  }
  ...
  createNewTodoFromEvent(event) {
    ...
    this._container.children[2].appendChild(todo);
  ...
  renderTodoItemsFromJSON(json) {
    ...
    json.forEach((currentItem) => this._container.children[2].appendChild(this.createNewTodo(currentItem.name, currentItem.description, currentItem.finished)));
